...
public class MapResizeMouseListener implements MouseListener, MouseMotionListener {
	JInternalFrame target;
	MainFrame frame;
	Point start_drag;
	Point start_loc;

	public MapResizeMouseListener(JInternalFrame toolBar, MainFrame frame) {
		this.target = toolBar;
		this.frame = frame;
	}
	...
	public void mouseDragged(MouseEvent e) {
		...
		int newWidth = frame.getSize().width + (int) offset.getX();
		int newHeight = frame.getSize().height + (int) offset.getY();
		...
		//int newWidth = (int) (this.start_loc.getX() + offset.getX());
		//int newHeight = (int) (this.start_loc.getY() + offset.getY());
